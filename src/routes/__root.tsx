...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Paqli" },
      { name: "description", content: "Paqli is a B2B SaaS for HR teams to create and share compensation packages." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Paqli" },
      { property: "og:description", content: "Paqli is a B2B SaaS for HR teams to create and share compensation packages." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Plus+Jakarta+Sans:wght@300;400;500;600&display=swap",
      },
    ],
  }),
